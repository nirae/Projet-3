...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'louvre_reservation.validator.antithousandbooking' => 'getLouvreReservation_Validator_AntithousandbookingService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4cSc0ztaqg', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yxKKD+zX7a', 0, '4vidSBxcBuA6Wr2Rd2VPOg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yRE01Yr1eg', 0, '4vidSBxcBuA6Wr2Rd2VPOg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Louvre\\ReservationBundle\\Entity'))), 'Louvre\\ReservationBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('LouvreReservationBundle' => 'Louvre\\ReservationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ec038dbbff67e9d86b09511215e1079ba7cf422281f9896714e43b3514f39beb');
    ...
    /*
     * Gets the 'louvre_reservation.validator.antithousandbooking' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Louvre\ReservationBundle\Validator\AntiThousandBookingValidator A Louvre\ReservationBundle\Validator\AntiThousandBookingValidator instance
     */
    protected function getLouvreReservation_Validator_AntithousandbookingService()
    {
        return $this->services['louvre_reservation.validator.antithousandbooking'] = new \Louvre\ReservationBundle\Validator\AntiThousandBookingValidator($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Louvre\\ReservationBundle/Resources/views'), 'LouvreReservation');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\ExpressionValidator' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'Symfony\\Component\\Security\\Core\\Validator\\Constraints\\UserPasswordValidator' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'Symfony\\Bridge\\Doctrine\\Validator\\Constraints\\UniqueEntityValidator' => 'doctrine.orm.validator.unique', 'anti_thousand_booking' => 'louvre_reservation.validator.antithousandbooking', 'Louvre\\ReservationBundle\\Validator\\AntiThousandBookingValidator' => 'louvre_reservation.validator.antithousandbooking')));
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H+Cg+lL1Ir', 0, '4vidSBxcBuA6Wr2Rd2VPOg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('580a15fcdc0394.54868864')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LouvreReservationBundle' => 'Louvre\\ReservationBundle\\LouvreReservationBundle',
            ),
            ...
            'validator.mapping.cache.prefix' => 'validator_cf4d50054795fdec919f83117882428634a8abee884cb110ccf6dd0ab044c036',
